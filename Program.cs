...
app.MapGet("HaalOpEigenaar/{ID}", async (IModel model, int ID) =>
{
    try
    {
...
app.MapPost("/VoegToe", async (IModel model, EIGENAAR eigenaar) =>
{
    try
    {
...
app.MapPut("/Muteer", async (IModel model, EIGENAAR eigenaar) =>
{
    try
    {
...
app.MapDelete("Verwijder/{ID}", async (IModel model, int ID) =>
{
    try
    {
